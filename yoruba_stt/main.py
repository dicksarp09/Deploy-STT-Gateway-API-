"""
Yoruba STT FastAPI Application.
Standalone FastAPI service for Yoruba speech-to-text transcription.
"""
import sys
import os
...
# Setup logger
logger = setup_logger("yoruba_stt")
...
async def lifespan(app: FastAPI):
    ...
    """
    # Startup
    logger.info("Starting Yoruba STT service...")
    ...
    # Shutdown
    logger.info("Shutting down Yoruba STT service...")


# Create FastAPI app
app = FastAPI(
    title="Yoruba STT API",
    version="3.0",
    description="Yoruba Speech-to-Text API using CLEAR-Global w2v-bert model",
    lifespan=lifespan
)
